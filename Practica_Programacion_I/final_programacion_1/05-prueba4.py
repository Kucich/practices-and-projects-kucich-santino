...
diccionario_de_regiones = {} # Diccionario en el cual guardo las regiones donde buscar hoteles
...
while True:
    ...
    if opcion == "1":
        ...
        # adultos = input("¿Cuantos adultos seran? : ")
        # habitaciones = input("¿Cuantas habitaciones necesitan? : ")
